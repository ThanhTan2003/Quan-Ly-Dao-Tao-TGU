...
{
    public partial class QuanLyDiemThi_Menu : UserControl
    {
        public QuanLyDiemThi_Menu()
        {
            InitializeComponent();
        }
        ...
        private void QuanLyDiemThi_Menu_Load(object sender, EventArgs e)
        {
            NhapDiemThi_QuanLyDiem user = new NhapDiemThi_QuanLyDiem();
